          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="hand-drawn-btn inline-flex items-center justify-center w-12 h-12 px-0"
                title="Report Bug"
              >
                <svg
                  className="w-5 h-5 text-[color:var(--text-color)]"
                ...
                >
                  <path d="M12 18h.01" />
                  <path d="M5.03 9a7 7 0 1 1 13.94 0" />
                  <path d="M12 13v-4" />
                  <path d="M9 16a3.5 3.5 0 0 0 7 0" />
                  <rect x="3" y="1" width="18" height="22" rx="2" ry="2" className="opacity-0" />
                  {/* Bug icon shape */}
                  <path d="M8 2v4" />
                  <path d="M16 2v4" />
                  <path d="M3 13h18" />
